...
def plot_ar_attempts(ar_data: dict[str, np.typing.NDArray], **hist_kwargs):
    ...
    Example:
        ...
        from qualibration_libs.legacy.lib.plot_utils import plot_ar_attempts
        ar_dat = {}
...
class QubitPairGrid:
    ...
    '''
    from qualibration_libs.legacy.lib.qua_datasets import grid_iter
...
class QubitGrid:
    ...
    '''
    from qualibration_libs.legacy.lib.qua_datasets import grid_iter, QubitGrid
    grid = QubitGrid(ds)
    ...
    '''
    from qualibration_libs.legacy.lib.qua_datasets import grid_iter, QubitGrid, grid_names
