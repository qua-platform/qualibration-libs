...
from calibration_utils.resonator_spectroscopy_vs_flux.plotting import (  # noqa: E402
...
def main():
    parser = argparse.ArgumentParser(description="Plot 02c resonator spectroscopy vs flux results.")
    ...
    for folder in candidates:
        ...
        try:
            fig.canvas.manager.set_window_title(f"02c: {folder.name}")
        except Exception:
            pass
        ...
        if args.save:
            ...
            out_path = out_dir / "res_spectroscopy_vs_flux.png"
