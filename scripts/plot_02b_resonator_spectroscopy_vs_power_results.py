...
from calibration_utils.resonator_spectroscopy_vs_amplitude.plotting import (  # noqa: E402
...
def main():
    parser = argparse.ArgumentParser(description="Plot 02b resonator spectroscopy vs power results.")
    ...
    for folder in candidates:
        ...
        try:
            fig.canvas.manager.set_window_title(f"02b: {folder.name}")
        except Exception:
            pass
        ...
        if args.save:
            ...
            out_path = out_dir / "res_spectroscopy_vs_power.png"
